...
/**
 * Created by suganyar on 27-04-2016.
 */
public class ObserverClass  extends FileObserver {
    ...
    public ObserverClass(String path) {
        this(path, ALL_EVENTS);
    }

    public ObserverClass(String path, int mask) {
        super(path, mask);
        mPath = path;
        mMask = mask;
    }
    ...
    class SingleFileObserver extends FileObserver {
        ...
        public void onEvent(int event, String path) {
            ...
            ObserverClass.this.onEvent(event, newPath);
        }
    }
}